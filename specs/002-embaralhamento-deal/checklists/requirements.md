...
- Escolhas autônomas registradas em Assumptions: permanecer em `main`; diretório `specs/002-embaralhamento-deal/`; burn continua opcional (já no casco); quiz stub pode não bater com o feltro até 003–006.
